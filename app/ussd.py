...
from dababase import get_case_officer_details, get_safe_house_location, get_staff_details
...
def handle_ussd_callback(session_id, service_code, phone_number, text, sms, airtime):
    ...
    if text == "":
        ...
        send_sms(phone_number, "Case officer contact details:\nName: {}\nPhone: {}".format(case_officer_details['name'], case_officer_details['phone']))
        ...
        send_sms(phone_number, "Safe house location: \nName: {}\nLocation: {}\nManager: {}\nContact: {}".format(safe_house_location['name'], safe_house_location['location'], safe_house_location['manager'], safe_house_location['contact']))
        ...
        send_sms(phone_number, "Staff contact details:\nName: {}\nPhone: {}".format(staff_details['name'], staff_details['phone']))
